...
const routes = [
  ...
  { path: '/platform/login', name: 'platform-login', component: () => import('./views/PlatformLoginView.vue'), meta: { public: true, platform: true } },
  {
    ...
    meta: { platform: true },
    children: [
      { path: '', name: 'platform-dashboard', component: () => import('./views/PlatformDashboardView.vue'), meta: { platform: true, title: 'Visão geral' } },
      { path: 'tenants', name: 'platform-tenants', component: () => import('./views/PlatformTenantsView.vue'), meta: { platform: true, title: 'Lavanderias' } },
      { path: 'revenue', name: 'platform-revenue', component: () => import('./views/PlatformRevenueView.vue'), meta: { platform: true, title: 'Receita por tenant' } },
      { path: 'accounting', name: 'platform-accounting', component: () => import('./views/PlatformAccountingView.vue'), meta: { platform: true, title: 'Contabilidade' } },
      { path: 'billing', name: 'platform-billing', component: () => import('./views/PlatformBillingView.vue'), meta: { platform: true, title: 'Cobrança' } },
      { path: 'invoices/:id', name: 'platform-invoice', component: () => import('./views/PlatformInvoiceView.vue'), meta: { platform: true, title: 'Fatura' } },
      { path: 'audit', name: 'platform-audit', component: () => import('./views/PlatformAuditView.vue'), meta: { platform: true, title: 'Log de auditoria' } },
    ],
  },
  {
    path: '/',
